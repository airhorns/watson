...
function(e, t, n) {
  ...
  function buildParams(e, t, n, r) {
    var i, s, o, u = /\[\]$/;
    if (isArray(t)) for (s = 0; t && s < t.length; s++) o = t[s], n || u.test(e) ? r(e, o) : buildParams(e + "[" + (typeof o == "object" ? s : "") + "]", o, n, r);
    else if (t.toString() === "[object Object]") for (i in t) buildParams(e + "[" + i + "]", t[i], n, r);
    else r(e, t)
  }
  var win = window,
    doc = document,
  ...
  return Reqwest.prototype = {
    ...
    else for (n in e) buildParams(n, e[n], i, u);
