    ...
    Tracker.prototype.finish = function(callback) {
      ...
      return Data.Report.findAll({
        ...
        return _this.report.save().on('failure', function(error) {
          ...
          return _this.report.setPoints(points).on('success', function() {
            return callback();
    ...
    MemoryTracker.prototype.run = function(callback) {
      ...
      return this.setup(function(err) {
        ...
        if (!_this.options.async) {
          for (i = 0, _ref = _this.iterations; 0 <= _ref ? i <= _ref : i >= _ref; 0 <= _ref ? i++ : i--) {
            _this.f(i);
            poll(i);
          }
          return finish();
      ...
      this.setup(function(error) {
        ...
        _this.suite.on('complete', function() {
          ...
          return _this.suite.each(function(bench) {
            ...
            return _this._saveReport(bench, function(error, report) {
