(function() {
  ...
  Tracker = (function() {
    ...
    Tracker.prototype.finish = function(callback) {
      ...
      return Data.Report.findAll({
        ...
        return report.save().error(function(error) {
          ...
          return report.setPoints(points).success(function() {
            return callback();
    ...
    Tracker.prototype._buildReport = function() {
      return Data.Report.build(this._reportParams());
    };

    Tracker.prototype._reportParams = function() {
      return {
        sha: this.sha,
        human: this.human,
        metric: this.metric,
