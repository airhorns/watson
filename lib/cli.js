  ...
  checkoutSHAWithTests = function(sha, rev, tmpDir, rootDir, options, config, callback) {
    ...
    return async.series([
      checkout = function(callback) {
        return tmpExec("git reset --hard && git checkout " + sha, function(err, stdout, stderr) {
          if (!err) {
  ...
  commands = {
      ...
      if (args.length === 0) {
        ...
        for (_i = 0, _len = args.length; _i < _len; _i++) {
          ...
          _results.push((function(key) {
            return Watson.Report.truncateKeyPattern(key).on('success', function() {
    ...
    run: function(args, options, config) {
      return async.auto({
        ...
        runTests: [
          'cloneToTemp', 'getTestFiles', 'parseRevs', 'syncTables', function(callback, results) {
